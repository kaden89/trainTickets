...
public interface TicketRepository extends CrudRepository<Ticket, Integer> {
    ...
    @Query("SELECT t FROM Ticket t LEFT JOIN t.reservation r WHERE t.trip.id = :tripId AND (t.reservation IS EMPTY OR r.reservationEndTime < CURRENT_TIMESTAMP) AND t.boughtUser is null ")
